...
function parseViewCount(raw: string | number): number {
...
// Parse relative date strings like "5 days ago", "2w ago", "1mo ago"
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '12px' }}>
      ...
      >
        ...
        {/* Changed: empty state uses filteredVideos */}
