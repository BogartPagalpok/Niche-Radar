...
const TASK_CHAINS: Record<AiTask, ProviderName[]> = {
  // Short + needs speed → Cerebras first.
  search: ['Cerebras', 'Groq', 'Gemini'],
  // Long-form complex reasoning → Cerebras 120B first, GPT-4o as quality backup.
  script: ['Cerebras', 'GitHub GPT-4o', 'Groq', 'Gemini'],
  // Creative visual language → GPT-4o first.
  thumbnail: ['GitHub GPT-4o', 'Cerebras', 'Groq', 'Gemini'],
  // Generic default.
  general: ['Cerebras', 'GitHub GPT-4o', 'Groq', 'Gemini'],
};
